...
describe('VeriFactu XML Generation - fixtures', () => {
    ...
    it.each(fixtures)('should generate valid XML for %s', async (fixtureFile) => {
        ...
        const xml = client.wsdl.objectToXML({ SuministroLR: contenido }, 'SuministroLR', 'sf', 'https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/sii/ws/SuministroFactEmitidas/v1.1/wsSuministroFactEmitidas.wsdl', true);
